...
contract Ownable is Context {
    ...
    */
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 2 days");
...
// File: contracts/protocols/Rewarder.sol
...
contract SecuredMoonRat is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    function claimBNBReward() isHuman nonReentrant public payable {
        require(msg.value >= claimFee, "fee is not enough");
    ...
    function activateContract() public onlyOwner {
        // reward claim
        disableEasyRewardFrom = block.timestamp + 2 days;
    ...
    function updateDisruptiveCoverageFee(uint256 _fee) public onlyOwner {
        disruptiveCoverageFee = _fee;
    }
}